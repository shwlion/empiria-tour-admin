 ...
 * button, as the Events admin keeps them in a drawer. The active pill is dark
 * — the Events admin's treatment — because the white one this replaced had
 * been invisible since the ground went white.
 */
...
export default function TopNav({
  ...
  const pill = (active: boolean) =>
    `inline-flex items-center rounded-full px-3.5 py-1.5 text-[13px] transition-colors ${
      active
        ? 'bg-[#1a1209] font-semibold text-white'
