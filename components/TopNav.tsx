...
const ITEMS: NavItem[] = [
  ...
  { name: 'Customers', href: '/dashboard/customers', icon: Users, built: true, requires: 'manageCustomers' },
  { name: 'Reports', href: '/dashboard/reports', icon: BarChart3, built: true, requires: 'viewFinance' },
